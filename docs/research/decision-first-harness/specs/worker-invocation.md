---
id: research.harness.worker-invocation
...
- Input is a packet identity plus a bounded instruction. Never a transcript.
- Output is a result: a diff, prose, or a structured answer, plus any escape-hatch requests.
...
- The same packet dispatched to two providers produces results that both pass verification for a
  fixture task.
