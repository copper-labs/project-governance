...
/** The eight first-RC consumers. Every entry names an actual supported caller. */
export const DECISION_CONSUMERS: Record<DecisionConsumerId, ConsumerDefinition> = {
  ...
  DL05: { id: "DL05", version: "1.0.0", area: "device diagnosis", caller: "workflow-status/workflow-wait deviceAdvice",
    questions: ["runtime.diagnostic-match/1", "runtime.next-probe/1"], supportedEffects: ["advise"],
